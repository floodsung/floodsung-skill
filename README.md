...
>
> 全量 152 篇专栏文章 + 178 条想法 + 254 个回答的人格语料，让 Claude Code 变成一个数字分身。你也可以 fork 这个模板，开源你自己。
...
| `data/` | 全量知乎原始语料（JSON + Markdown），共 584 条 / 约 90 万字 |
| `scripts/` | 知乎爬虫 + 分析工具 |
...
Flood Sung 从 2016 年开始在知乎写作，累积 152 篇专栏文章 + 254 个回答 + 178 条想法。这是一个足够大、足够稳定、足够有辨识度的 corpus。这个 repo 把所有原料 + 提炼好的 skill 开源出来，任何人都可以：
